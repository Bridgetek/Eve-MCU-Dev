# EVE-MCU-Dev Flightdeck BT82X Raspberry Pi pico VSCode Example

[Back](../README.md)

## Compiling using the pico VSCode Extension

The workspace file `flightdeck-bt82x.code-workspace` can be loaded directly in Visual Studio Code (VS Code) to load the project as a workspace.

### Setting Up the Flightdeck BT82X Raspberry Pi pico VSCode Example
...
### Compiling the Flightdeck BT82X Raspberry Pi pico VSCode Example
...
### Setting Up the Flightdeck BT82X Raspberry Pi pico Example Manually
...
### Compiling the Flightdeck BT82X Raspberry Pi pico Example Manually
...
The UF2 file for programming onto the board is `flightdeck-bt82x_pico.uf2` in the `build` directory.
