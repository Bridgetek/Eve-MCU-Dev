# EVE-MCU-Dev Flightdeck BT820 Example for libmpsse
...
The executable file is `build\Debug\flightdeck-bt82x_libmpsse.exe` or `build\flightdeck-bt82x_libmpsse.exe`. This can be run from the command line. 
