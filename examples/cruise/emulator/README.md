# EVE-MCU-Dev Cruise Example for the EVE Emulator
...
The executable file is normally `build\Debug\cruise_emulator.exe` or  `build\cruise_emulator.exe`. This can be run from the command line. 
