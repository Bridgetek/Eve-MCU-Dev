# EVE-MCU-Dev MedInfo Example for the EVE Emulator
...
The executable file is normally `build\Debug\medinfo_emulator.exe` or  `build\medinfo_emulator.exe`. This can be run from the command line. 
