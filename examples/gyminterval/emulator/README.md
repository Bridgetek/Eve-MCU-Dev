# EVE-MCU-Dev GymInterval Example for the EVE Emulator
...
The executable file is normally `build\Debug\gyminterval_emulator.exe` or  `build\gyminterval_emulator.exe`. This can be run from the command line. 
