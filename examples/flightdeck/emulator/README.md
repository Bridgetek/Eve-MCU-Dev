# EVE-MCU-Dev Flightdeck Example for the EVE Emulator
...
The executable file is normally `build\Debug\flightdeck_emulator.exe` or  `build\flightdeck_emulator.exe`. This can be run from the command line. 
