# EVE-MCU-Dev Colour Picker Example for the EVE Emulator
...
The executable file is normally `build\Debug\colourpicker_emulator.exe` or  `build\colourpicker_emulator.exe`. This can be run from the command line. 
