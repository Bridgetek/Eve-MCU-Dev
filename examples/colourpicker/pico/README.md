# EVE-MCU-Dev Colour Picker VRaspberry Pi pico VSCode Example

[Back](../README.md)

## Compiling using the pico VSCode Extension

The workspace file `colourpicker.code-workspace` can be loaded directly in Visual Studio Code (VS Code) to load the project as a workspace.

### Setting Up the Colour Picker Raspberry Pi pico VSCode Example
...
### Compiling the Colour Picker Raspberry Pi pico VSCode Example
...
### Setting Up the Colour Picker Raspberry Pi pico Example Manually
...
The UF2 file for programming onto the board is `colourpicker_pico.uf2` in the `build` directory.
