# EVE-MCU-Dev Font Magic Raspberry Pi pico VSCode Example

[Back](../README.md)

## Compiling using the pico VSCode Extension

The workspace file `fontmagic.code-workspace` can be loaded directly in Visual Studio Code (VS Code) to load the project as a workspace.

### Setting Up the Font Magic Raspberry Pi pico VSCode Example
...
### Compiling the Font Magic Raspberry Pi pico VSCode Example
...
### Setting Up the Font Magic Raspberry Pi pico Example Manually
...
### Compiling the Font Magic Raspberry Pi pico Example Manually
...
The UF2 file for programming onto the board is `fontmagic_pico.uf2` in the `build` directory.
