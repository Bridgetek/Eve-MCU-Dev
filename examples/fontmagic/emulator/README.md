# EVE-MCU-Dev FontMagic Example for the EVE Emulator
...
The executable file is normally `build\Debug\fontmagic_emulator.exe` or  `build\fontmagic_emulator.exe`. This can be run from the command line. 
