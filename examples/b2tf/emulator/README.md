# EVE-MCU-Dev b2tf Example for the EVE Emulator
...
The executable file is normally `build\Debug\b2tf_emulator.exe` or  `build\b2tf_emulator.exe`. This can be run from the command line. 
