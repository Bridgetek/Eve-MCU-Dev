...
The workspace file `b2tf.code-workspace` can be loaded directly in Visual Studio Code (VS Code) to load the project as a workspace.

### Setting Up the B2TF Raspberry Pi pico VSCode Example
...
### Compiling the B2TF Raspberry Pi pico VSCode Example
...
### Setting Up the B2TF Raspberry Pi pico Example Manually
...
The UF2 file for programming onto the board is `b2tf_pico.uf2` in the `build` directory.
