...
void EVE_Init(void)
{
    ...
    EVE_CMD_REGWRITE(EVE_REG_SC0_PTR0, 0x7d80000 - (EVE_DISP_WIDTH * EVE_DISP_HEIGHT * 3));
    EVE_CMD_REGWRITE(EVE_REG_SC0_PTR1, 0x7d80000 - (2 * EVE_DISP_WIDTH * EVE_DISP_HEIGHT * 3));
