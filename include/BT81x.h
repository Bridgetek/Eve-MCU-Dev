...
#define EVE_ENC_BITMAP_HANDLE(handle)                           ((0x05ul << 24)|(((handle) & 0x1ful) << 0))
#define EVE_ENC_BITMAP_LAYOUT(format,linestride,height)         ((0x07ul << 24)|(((format) & 0x1ful) << 19)|(((linestride) & 0x3fful) << 9)|(((height) & 0x1fful) << 0))
#define EVE_ENC_BITMAP_LAYOUT_H(linestride,height)              ((0x28ul << 24)|(((linestride) & 0x3ul) << 2)|(((height) & 0x3ul) << 0))
#define EVE_ENC_BITMAP_SIZE(filter,wrapx,wrapy,width,height)    ((0x08ul << 24)|(((filter) & 0x1ul) << 20)|(((wrapx) & 0x1ul) << 19)|(((wrapy) & 0x1ul) << 18)|(((width) & 0x1fful) << 9)|(((height) & 0x1fful) << 0))
#define EVE_ENC_BITMAP_SIZE_H(width,height)                     ((0x29ul << 24)|(((width) & 0x3ul) << 2)|(((height) & 0x3ul) << 0))
#define EVE_ENC_BITMAP_SOURCE(addr)                             ((0x01ul << 24)|((addr) & EVE_ENC_BITMAP_ADDR_MASK))
#define EVE_ENC_BITMAP_SOURCE2(flash_or_ram, addr)              ((0x01ul << 24)|(((flash_or_ram)&1) << 23) | (((addr) & (EVE_ENC_BITMAP_ADDR_MASK >> 1)) << 0))
...
#define EVE_ENC_CLEAR_COLOR_RGB(red,green,blue)                 ((0x02ul << 24)|(((red) & 0xfful) << 16)|(((green) & 0xfful) << 8)|(((blue) & 0xfful) << 0))
...
#define EVE_ENC_COLOR_RGB(red,green,blue)                       ((0x04ul << 24)|(((red) & 0xfful) << 16)|(((green) & 0xfful) << 8)|(((blue) & 0xfful) << 0))
...
#define EVE_ENC_TAG(s)                                          ((0x03ul << 24)|(((s) & 0xfful) << 0))
...
#define EVE_ENC_VERTEX2II(x,y,handle,cell)                      ((0x02ul << 30)|((((uint32_t)(x)) & 0x1fful) << 21)|((((uint32_t)(y)) & 0x1fful) << 12)|(((handle) & 0x1ful) << 7)|(((cell) & 0x7Ful) << 0))
