...
#define EVE_ENC_BITMAP_HANDLE(handle)                           ((0x05ul << 24)|(((handle) & 0x3ful) << 0))
...
#define EVE_ENC_BITMAP_SOURCE(addr)                             ((0x01ul << 24)|((addr) & 0xfffffful))
...
#define EVE_ENC_TAG(s)                                          ((0x03ul << 24)|((((uint32_t)(s)) & 0xfffffful) << 0))
