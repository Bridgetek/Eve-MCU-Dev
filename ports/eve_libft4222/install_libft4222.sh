...
if [[ $PROCESSOR_ARCHITECTURE == "AMD64" ]]; then
    ...
    INSTALL_FT4222_LIB=LibFT4222-64.lib
elif [[ $PROCESSOR_ARCHITECTURE == "x86" ]]; then
    echo Installing x86 libraries from "$1"
    INSTALL_PATH_FT4222=LibFT4222/dll/i386
    INSTALL_PATH_FTD2XX=ftd2xx/dll/i386
    INSTALL_FT4222_DLL=LibFT4222.dll
    INSTALL_FT4222_LIB=LibFT4222.lib
...
cp "$INSTALL_PATH/$INSTALL_PATH_FT4222/$INSTALL_FT4222_LIB" libft4222.lib
